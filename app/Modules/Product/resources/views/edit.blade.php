...
<div class="card">
  ...
  <form action="{{ url('/admin/product/update',[$product->id]) }}" method="post" enctype="multipart/form-data">
      ...
      {!! csrf_field() !!}
        ...
        <label>URL</label></br>
        <input type="text" value="{{ $product->url }}" name="url" id="product_input_url" class="form-control" value="" >
        ...
        <img src="{{ asset('uploads/products/'.$product->image) }}" width="80px" height="100px" alt="image"><br><br>
