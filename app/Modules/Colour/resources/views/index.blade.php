...
<a class="btn btn-success float-right" href="{{ route('colour.add') }}" role="button">Add</a>

        <a class="btn btn-danger float-right" href="{{ route('colour.showtrash') }}" role="button">Trash</a>
</div>
                            ...
                            <td>{{$col->updated_at}}</td>
                             <td>
                                <div>
                                    ...
                                    <a href="{{ url('/admin/colour/edit',[$col->id]) }}" class="edit"><i class="fas fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="{{ route('colour.index') }}"class="delete" data-id="{{ $col->id }}"><i class="fas fa-trash-alt"></i>        </a>
                                </div>
                             </td>


                                {{-- <a href="{{ route('colour.add') }}"class="delete"  onclick="event.preventDefault();
