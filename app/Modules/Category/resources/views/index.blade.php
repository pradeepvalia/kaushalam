...
@section('maincontent')
    <div class="card">
        <div class="card-header">
            ...
            <a class="btn btn-success float-right" href="{{ route('category.add') }}" role="button">Add</a>&nbsp; &nbsp;
            &nbsp;

            <a class="btn btn-danger float-right" href="{{ route('category.showtrash') }}" role="button">Trash</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href="{{ url('/admin/category/edit', [$col->id]) }}" class="edit"><i
                            ...
                            {{-- <a href="{{ route('category.index2') }}"class="delete"  onclick="event.preventDefault();
                                    document.getElementById('#delete-form--{{$col->id}}').submit();"></a>
                                     <form id="delete-form-{{$col->id}}" action="{{ route('category.delete',$col->id) }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                        @method('DELETE')
                                    </form> --}}
