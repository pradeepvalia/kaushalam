...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  ...
  <strong></strong> You successfully add your Category.
</div>
@endif
{{-- session --}}
<style>
...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ route('category.save') }}" id="formc" method="post">
        {!! csrf_field() !!}
        ...
        <label for="css">Inactive</label><br><br> -->
        <input type="submit" value="Save" class="btn btn-success">
        <a class="btn btn-danger float-left" href="{{ route('category.add') }}" role="button">Cancel</a></br>
    </form>
